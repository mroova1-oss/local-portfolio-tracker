...
# ------------------------------------------------------
def main():
    st.set_page_config(page_title="Local Portfolio Tracker & Pension Plan", page_icon="💰", layout="wide")
    inject_css()
    ...
    if st.sidebar.button("✅ Zaloguj / Odśwież widok"):
        # samo kliknięcie tego przycisku nie robi nic, hasło sprawdzamy niżej
        pass
...
"""
    ...
    st.sidebar.markdown("---")
    # PRAWDZIWY PRZYCISK ODŚWIEŻANIA – czyści cache i przeładowuje appkę
    ...
    portfolio_now = net_pln  # użyjemy tego w plannerze i zakładce Pension Progress
...
"""
        ...
        age_end = 90  # stałe założenie – do 90. roku życia
